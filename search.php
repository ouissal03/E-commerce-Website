...
if(mysqli_connect_errno()) {
 ...
 $query="SELECT * FROM produits WHERE (`NomPro` LIKE '%".$search."%')";
...
<section class="header">
	...
	<p align="center" class="titre">le resultat de chercher "<?php echo $search; ?>"</p>
</section>
<div class="row">
<?PHP  
$query="SELECT * FROM produits WHERE (`NomPro` LIKE '%".$search."%')";
      ...
      <!--product-box-1---------->
                <div class="product-box">
                      ...
                      <div class="product-img">
                          <!--img------>
                         <img  href="produit.php?id=<?=$row["NumPro"]?>" src="<?=$row["ImgPro"] ?>">
                      </div>
                      <!--product-details-------->
                      <div class="product-details">
                        ...
                        <i class="fas fa-star"></i>
                          ...
                          <a class="achat" align="center" href="produit.php?id=<?=$row["NumPro"] ?>" ><h5>Add to Cart&nbsp;<i class="fas fa-shopping-cart"></i></h5></a>
                      </div>
                  </div>
              </div>
<?php 
